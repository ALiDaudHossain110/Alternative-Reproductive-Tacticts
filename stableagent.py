...
class Agent(pg.sprite.Sprite):
    ...
    def perceive(self, agents, food_group):
        ...
        for agent in agents:
            if agent is not self:
                if self.age > 1 and self.energy_level > 3:
    ...
    def data(self):
        ...
        input[5] = self.energy_level/400  # Add normalized energy level
        input[6] = self.age/20#add age  
        return input
